...
namespace eval ttk::theme::park-light {

    variable version 1.0
    package provide ttk::theme::park-light $version
    variable colors
    array set colors {
        -fg             "#313131"
        -bg             "#ffffff"
    ...
    # Settings
    ttk::style theme create park-light -parent default -settings {
        ttk::style configure . \
        ...
        # Toggle.TButton
        ttk::style configure Toggle.TButton -padding {8 4 8 4} -width -10 -anchor center -foregound $colors(-fg)
