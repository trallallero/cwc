    ...
    ttk::style theme create park-dark -parent default -settings {
        ...
        ttk::style layout TCombobox {
            Combobox.field -sticky nswe -children {
                Combobox.padding -expand false -sticky nswe -children {
        ...
        ttk::style map TCombobox -selectbackground [list \
            {!focus} $colors(-disabledfg) \
            {readonly hover} $colors(-selectbg) \
            {readonly focus} $colors(-disabledfg) \
        ]

        ttk::style map TCombobox -selectforeground [list \
            {!focus} $colors(-selectfg) \
            {readonly hover} $colors(-selecthover) \
        ...
        ttk::style element create Combobox.field image \
            [list $I(border-basic) \
                ...
                {focus hover} $I(border-accent) \
                readonly $I(border-basic) \
                invalid $I(border-invalid) \
                disabled $I(border-basic) \
                focus $I(border-accent) \
                hover $I(border-hover) \
            ] -border 5 -padding {8 8 10 8}

        ttk::style element create Combobox.button image \
            [list $I(combo-button-basic) \
                 {disabled} $I(combo-button-disabled) \
