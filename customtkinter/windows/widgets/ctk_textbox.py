...
class CTkTextbox(CTkBaseClass):
    ...
    def __init__(self,
        ...
        self._textbox.configure(yscrollcommand=self._y_scrollbar.set_v)
        ...
        self._textbox.configure(xscrollcommand=self._x_scrollbar.set_h)
