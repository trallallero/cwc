...
class CTkScrollableFrame(tkinter.Frame, CTkAppearanceModeBaseClass, CTkScalingBaseClass):
    def __init__(self,
        ...
        if self._orientation == "horizontal" or self._orientation == "both":
            self._scrollbar_h = CTkScrollbar(master=self._parent_frame, orientation="horizontal", command=self._parent_canvas.xview,
                                           fg_color=scrollbar_fg_color, button_color=scrollbar_button_color, button_hover_color=scrollbar_button_hover_color)
            self._parent_canvas.configure(xscrollcommand=self._scrollbar_h.set_h)
        if self._orientation == "vertical" or self._orientation == "both":
            self._scrollbar_v = CTkScrollbar(master=self._parent_frame, orientation="vertical", command=self._parent_canvas.yview,
                                           fg_color=scrollbar_fg_color, button_color=scrollbar_button_color, button_hover_color=scrollbar_button_hover_color)
            self._parent_canvas.configure(yscrollcommand=self._scrollbar_v.set_v)
    ...
    def scroll_y(self, amount):
        if self._scrollbar_v:
            self._scrollbar_v.scroll(amount=amount)
    ...
    def _create_grid(self):
        ...
        if self._orientation == "horizontal" or self._orientation == "both":
            ...
            self._scrollbar_h.grid(row=2, column=0, sticky="nsew", padx=border_spacing, pady=(0, 3))
        ...
        if self._orientation == "vertical" or self._orientation == "both":
            ...
            self._scrollbar_v.grid(row=1, column=1, sticky="nsew", pady=border_spacing, padx=(0, 3))
    ...
    def configure(self, **kwargs):
        ...
        if "scrollbar_button_color" in kwargs:
            button_color = kwargs.pop("scrollbar_button_color")
            if self._scrollbar_h:
                self._scrollbar_h.configure(button_color=button_color)
            if self._scrollbar_v:
                self._scrollbar_v.configure(button_color=button_color)
    ...
    def cget(self, attribute_name: str):
        if attribute_name == "width":
            ...
            return self._scrollbar_h.cget("fg_color") if self._scrollbar_h else self._scrollbar_v.cget("fg_color")
        elif attribute_name.startswith("scrollbar_button_color"):
            return self._scrollbar_h.cget("button_color") if self._scrollbar_h else self._scrollbar_v.cget("button_color")
        elif attribute_name.startswith("scrollbar_button_hover_color"):
            return self._scrollbar_h.cget("button_hover_color") if self._scrollbar_h else self._scrollbar_v.cget("button_hover_color")
